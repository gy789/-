...
public interface ExpressageMapper {
    ...
    List<Expressage> getAllExpressageInfo(@Param("type") int type,@Param("expressage_logistics_company")String expressage_logistics_company,@Param("role")String role,Users users);//得到所有的快递信息(0:所有快递，1：待接收快递，2：快递员查询物流公司快递)
