...
public interface ExpressageService {
    ...
    List<Expressage> getAllExpressageInfo(@Param("type")int type,@Param("role")String role,@Param("expressage_logistics_company")String expressage_logistics_company);//得到所有的快递信息
