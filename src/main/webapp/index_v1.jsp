...
<div class="wrapper wrapper-content">
    ...
    <!-- Flot -->
    <script src="expressage/js/plugins/flot/jquery.flot.js"></script>
    <script src="expressage/js/plugins/flot/jquery.flot.tooltip.min.js"></script>
    <script src="expressage/js/plugins/flot/jquery.flot.resize.js"></script>
